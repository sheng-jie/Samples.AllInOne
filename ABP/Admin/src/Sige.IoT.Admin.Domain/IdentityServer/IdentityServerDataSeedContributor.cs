...
namespace Sige.IoT.Admin.IdentityServer
{
        ...
        private async Task CreateClientsAsync()
        {
            ...
            if (!webClientId.IsNullOrWhiteSpace())
            {
                ...
                await CreateClientAsync(
                    ...
                    commonScopes,
                    new[] { "hybrid" },
                    (configurationSection["Admin_Web:ClientSecret"] ?? "1q2w3e*").Sha256(),
            ...
            //Console Test Client
            var consoleClientId = configurationSection["Admin_App:ClientId"];
            if (!consoleClientId.IsNullOrWhiteSpace())
            {
                await CreateClientAsync(
                    ...
                    (configurationSection["Admin_App:ClientSecret"] ?? "1q2w3e*").Sha256()
                );
            }
        }
