...
namespace Sige.IoT.Admin.EntityFrameworkCore
{
     ...
     * used modules (as explained above). See AdminMigrationsDbContext for migrations.
     */
    ...
    public class AdminDbContext : AbpDbContext<AdminDbContext>
    {
         ...
         * Also map them inside AdminDbContextModelCreatingExtensions.ConfigureAdmin
         */
