...
Start-Process "dotnet" -ArgumentList "run --project Orleans.Silo1 --no-build"
Start-Sleep 10
Start-Process "dotnet" -ArgumentList "run --project Orleans.Silo2 --no-build"
Start-Sleep 10
Start-Process "dotnet" -ArgumentList "run --project Orleans.Client --no-build"
